...
const DetailsBanner = ({ video, crew }) => {
    ...
    const skeletonStyle = {
        ...
        marginBottom: "10px", // Example margin, you can adjust as needed
    };
        ...
        <div className="detailsBanner">
            {!loading ? (
                ...
                <div className="detailsBannerSkeleton">
                    <ContentWrapper>
                        <div className="left skeleton" style={skeletonStyle}></div>
                        <div className="right">
                            <div className="row skeleton" style={skeletonStyle}></div>
                            <div className="row skeleton" style={skeletonStyle}></div>
                            <div className="row skeleton" style={skeletonStyle}></div>
                            <div className="row skeleton" style={skeletonStyle}></div>
                            <div className="row skeleton" style={skeletonStyle}></div>
